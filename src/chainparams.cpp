// Casfdasdfopyasdfasdfasdfright (c) 2010 Satoshi Nakamoto
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000017e2f42edd4c8a960af6b10d39b6e42755b51be9dcc0ed9df1cb0c8c9e13f"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1536571334, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("040d74266902e3eda97753d744328237872309a95b42a74b22d7580e56b086fbc19ae1d6ef30c9e27d060c9c48692a663b9a321161e19f853ca6a6499cba7d17f6");
        nDefaultPort = 42857;
        ...
        nTargetSpacing = 1 * 90;  // Solar: 90sec
        nLastPOWBlock = 250;
        nMaturity = 79;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "dont fork this coin";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0457c56e42641f42398804504fcab82f430cc864c8fc8cd25b76e141d12c13012ee9d500e11f84d5f75f5c669e88ca196142ddb7406d3635d840fa5e9d2a6bb100") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1536572333;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 25493;
	...
	std::cout << "txNew:" << std::endl << txNew.ToString() << std::endl << std::endl;
        ...
        nStartMasternodePayments = 1536571334; //Wed, 2 Aug 2018 16:36:16 GMT
    }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Solar: 1 day
        nTargetSpacing = 1.5 * 60;  // Solar: 1 minute
        nLastPOWBlock = 150;
        nMaturity = 79;
        ...
        genesis.nTime = 1536571334;
        genesis.nNonce = 25493;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000017e2f42ed4c8a960af6b10d39b6e42755b51be9dcc0ed9df1cb0c8c9e13f"));
        ...
        nStartMasternodePayments = 1536571334; //Fri, 09 Jan 2015 21:05:58 GMT
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
